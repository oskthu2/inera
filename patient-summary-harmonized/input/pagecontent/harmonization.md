...
- **Xt-EHR EHDSPatientSummary.header.identifier 1..* (SHALL)** → FHIR `Composition.identifier` är 0..1, därför harmoniseras till `Composition.identifier 1..1` och avvikelsen dokumenteras.
